...
## [0.2.1](https://github.com/pmcgleenon/reqsketch-rs/compare/v0.2.0...v0.2.1) - 2026-06-11

### Other

- release v0.2.0 ([#26](https://github.com/pmcgleenon/reqsketch-rs/pull/26))

## [0.2.0](https://github.com/pmcgleenon/reqsketch-rs/compare/v0.1.4...v0.2.0) - 2026-06-11

### Added

- [**breaking**] queries on &self, user-managed SortedView snapshots ([#25](https://github.com/pmcgleenon/reqsketch-rs/pull/25))
...
- align compactor section-doubling schedule with C++ reference ([#17](https://github.com/pmcgleenon/reqsketch-rs/pull/17))
